...
# Delete Old Data
if os.path.exists('Data/GenreOutput') and os.path.isdir('Data/GenreOutput'):
    shutil.rmtree('Data/GenreOutput')

# Create Training, Testing, Validation Folders
splitfolders.ratio('Data/Genre', output='Data/GenreOutput', seed=1337, ratio=(.8, .1, .1))

# Settings
img_width, img_height = 268, 182
train_data_dir = 'Data/GenreOutput/train'
test_data_dir = 'Data/GenreOutput/test'
validation_data_dir = 'Data/GenreOutput/val'
classCount = len(next(os.walk('Data/Genre'))[1])
